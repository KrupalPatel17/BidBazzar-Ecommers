      ...
      <nav class="navbar">
         <div class="logo-container">
              <div class="logo">
                  <table>
                          <tr>
                             <td><a href="home.php"><h2>Bid</h2></a></td><td> <a href="home.php"><img src="img/logo.png"  alt="Rotating Image" class="rotating-logo"></a></td> <td><a href="home.php"><h2>Bazzar</h2></a></td>
                          </tr>
                  </table>
              </div>
          </div>
          ...
          <ul class="nav-links" >
              <li><a href="#">Cart <i class="ri-shopping-cart-2-line"></i></a></li>
              <li><a href="#">Auction <i class="ri-auction-line"></i></a></li>
              <li><a href="profil.php?bid=<?php include("connect.php"); $select="select * from tbl_user where user_id=$_SESSION[users_id]"; $result = mysqli_query($connect, $select);$row = mysqli_fetch_array($result); echo $row[0];?>;">Profile<i class="ri-file-user-line"></i></a></li>
